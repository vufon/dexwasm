...
# This is a copy of the create-dmg script from
# https://github.com/create-dmg/create-dmg and is licensed under the MIT.
...
# Directory containing the applescript file.
